...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/webhook/zenvia/email": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Webhook processed successfully (includes cases where message ID is not found)",
                        "schema": {
    ...
    "tags": [
        ...
        {
            "description": "Endpoints for receiving Zenvia webhook events (email and SMS status updates)",
            "name": "Webhooks"
        }
    ],
    "x-extension-openapi": {
